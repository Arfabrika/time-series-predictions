...
class NARX:
    ...
    def predict(self):
        ...
        narx_model.fit(x[self.window_params["start_pos"]:self.window_params["stop_pos"]],
                       y[self.window_params["start_pos"]:self.window_params["stop_pos"]],
                       epochs=self.epoch_cnt, validation_split=0, verbose=0)
